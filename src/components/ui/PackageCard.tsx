    ...
    >
      ...
      <div className="flex flex-col gap-8">
        <a
          ...
          className={`py-2 lg:py-3 w-full text-center rounded-full  fluid-text--base polysans-median border-2 transition-colors duration-300 hover:text-neutral-950 hover:bg-[${color}]`}
          style={{
            borderColor: color as string,
