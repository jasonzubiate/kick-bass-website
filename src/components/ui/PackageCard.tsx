  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-8">
        <a
          href={link || 'https://www.launchpass.com/k-and-b-tech-house/k-and-b-tech-house/v3'}
          target="_blank"
          rel="noopener noreferrer"
          className={`py-2 lg:py-3 w-full text-center rounded-full  fluid-text--base polysans-median border-2 transition-colors duration-300 hover:text-codGray hover:bg-[${color}]`}
          style={{
            borderColor: color as string,
        ...
        <ul className="flex flex-col gap-1 lg:gap-2 m-0">
          {features?.map((feature, index) => (
            <li key={index} className="text-[clamp(16px,1vw,20px)] text-neutral-400">
